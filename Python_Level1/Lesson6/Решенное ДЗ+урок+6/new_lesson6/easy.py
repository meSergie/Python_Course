...
sportCar = SportCar(240, 'Красная', 'Спортивная машина')
townCar = TownCar(140, 'Серая', 'Городская машина')
workCar = WorkCar(90, 'Желтая', 'Рабочая машина')
policeCar = PoliceCar(210, 'Синяя', 'Полицейская машина')
